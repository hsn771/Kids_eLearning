        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="bg-light rounded">
                    <div class="row g-0">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style={{minHeight: '400px'}}>
                            <div class="position-relative h-100">
                                <img class="position-absolute w-100 h-100 rounded" src="assets/img/call-to-action.jpg" style={{objectFit: 'cover'}}/>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle" src="assets/img/classes-5.jpg" alt=""/>
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle" src="assets/img/classes-6.jpg" alt=""/>
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                ...
                <div class="bg-light rounded">
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style={{minHeight: '400px'}}>
                            <div class="position-relative h-100">
                                <img class="position-absolute w-100 h-100 rounded" src="assets/img/appointment.jpg" style={{objectFit: 'cover'}}/>
                            </div>
                        </div>
                    </div>
                </div>
